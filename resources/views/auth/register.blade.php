            ...
            <div class="flex flex-col gap-5">
                ...
                <form action="{{ route('register') }} method="post" class="flex flex-col gap-2.5">
                    ...
                    <div class="flex gap-2">
                        ...
                        <x-inputContainer label="Logradouro *" type="text" name="address" placeholder="Seu logradouro..." />
                    </div>
                    <div class="flex gap-2">
                        <x-inputContainer label="Bairro *" type="text" name="neighborhood" placeholder="Seu bairro..."  />
                        <x-inputContainer label="Cidade *" type="text" name="city" placeholder="Sua cidade..."  />
                    </div>
                    <div class="flex gap-2">
                        <x-inputContainer label="Estado *" type="text" name="state" placeholder="Seu estado..."  />
                        <x-inputContainer label="Número *" type="text" name="number" placeholder="Seu número..."  />
                    </div>
